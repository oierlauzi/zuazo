...
/**
 * HOW TO COMPILE:
 * g++ Example4.cpp -o Example4 -std=c++17 -lzuazo -lavutil -lavformat -lavcodec -lswscale -lglfw `/usr/lib/x86_64-linux-gnu/ImageMagick-6.9.10/bin-q16/Magick++-config --cppflags --cxxflags --ldflags --libs`
 * HOW TO RUN:
