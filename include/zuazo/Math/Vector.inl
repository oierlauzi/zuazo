...
template<typename T, int dim>
constexpr Math::Vec<T, dim> abs(const Math::Vec<T, dim>& v) noexcept {
	return glm::abs(v);
}

template<typename T, int dim>
constexpr Math::Vec<T, dim> inv(const Math::Vec<T, dim>& v) noexcept {
	return Math::Vec<T, dim>(1) / v;
}

template<typename T, int dim>
constexpr Math::Vec<T, dim> floor(const Math::Vec<T, dim>& v) noexcept {
	return glm::floor(v);
}

template<typename T, int dim>
constexpr Math::Vec<T, dim> trunc(const Math::Vec<T, dim>& v) noexcept {
	return glm::trunc(v);
}

template<typename T, int dim>
constexpr Math::Vec<T, dim> ceil(const Math::Vec<T, dim>& v) noexcept {
	return glm::ceil(v);
}

template<typename T, int dim>
constexpr Math::Vec<T, dim> round(const Math::Vec<T, dim>& v) noexcept {
	return glm::round(v);
}

template<typename T, int dim>
constexpr Math::Vec<T, dim> frac(const Math::Vec<T, dim>& v) noexcept {
	return v - trunc(v);
}
