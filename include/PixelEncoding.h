...
/**
 * PixelEncoding represents how color components are encoded in it's allocated space
 */
enum class PixelEncoding {
	NONE = 0,					///<Not supported

	UINT,						///<Linearly encoded on a unsigned integer
	UINT_NARROW,				///<Linearly encided on a unsigned integer, leaving head-room and foot-room. \see https://www.itu.int/rec/R-REC-BT.601/en
...
ZUAZO_ENUM_ARITHMETIC_OPERATORS(PixelEncoding)
ZUAZO_ENUM_COMP_OPERATORS(PixelEncoding)	
